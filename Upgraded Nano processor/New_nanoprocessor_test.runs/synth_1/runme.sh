...
HD_PWD='E:/Submission Projects/Upgraded Nano processor/New_nanoprocessor_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MICRO_PROCESSOR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MICRO_PROCESSOR.tcl
