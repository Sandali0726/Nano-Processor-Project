...
HD_PWD='E:/Submission Projects/Upgraded Nano processor/New_nanoprocessor_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MICRO_PROCESSOR.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MICRO_PROCESSOR.tcl -notrace
