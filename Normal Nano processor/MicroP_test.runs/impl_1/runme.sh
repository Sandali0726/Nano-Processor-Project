...
HD_PWD='E:/Submission Projects/Normal Nano processor/MicroP_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log M_P.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source M_P.tcl -notrace
