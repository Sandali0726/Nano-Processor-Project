...
HD_PWD='E:/Submission Projects/Normal Nano processor/MicroP_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log M_P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source M_P.tcl
